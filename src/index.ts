...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  switch (request.params.name) {
    case "get_markets":
      return await getMarkets.run(args as any);
    case "get_events":
      return await getEvents.run(args as any);
    case "get_user_positions":
      return await getUserPositions.run(args as any);
    case "get_user_activity":
      return await getUserActivity.run(args as any);
    case "get_market_prices":
      return await getMarketPrices.run(args as any);
    case "get_trades":
      return await getTrades.run(args as any);
    case "get_order_book":
      return await getOrderBook.run(args as any);
    case "get_market_holders":
      return await getMarketHolders.run(args as any);
    default:
